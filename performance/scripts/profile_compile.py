#!/usr/bin/env python
"""Profile dbt compile to identify performance bottlenecks."""
import cProfile
import pstats
import io
import sys
...
try:
    cli(["compile", "--no-version-check", "--profiles-dir", "../../project_config/"])
except SystemExit:
    pass
...
profiler.dump_stats("/tmp/dbt_compile_profile.prof")
